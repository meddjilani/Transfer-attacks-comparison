...
class SubsetCifar10(Dataset): #medben
    def __init__(self, root, class_to_idx='./cifar10_image_to_label.npy', transform=None): #medben
        super(SubsetCifar10, self).__init__() #medben
        self.root = root
    ...
    def __getitem__(self, item):
        ...
        class_name = self.img_path[item].split('.')[0] #medben
        label = self.class_to_idx[class_name] #medben
