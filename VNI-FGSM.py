...
if __name__ == '__main__':
    ...
    parameters = {'attack': 'VNI-FGSM', **vars(args), **config}
    ...
    for batch_ndx, (x_test, y_test) in enumerate(loader):
        ...
        attack = torchattacks.VNIFGSM(source_model, eps=args.eps, alpha=args.alpha, steps=args.steps, decay=args.decay, N=args.N, beta=args.beta)
