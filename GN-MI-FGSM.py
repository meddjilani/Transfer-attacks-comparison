...
from utils.modelzoo_ghost.robustbench.robustbench.utils import load_model as load_model_ghost
import torchattacks
import json
import os
import argparse
...
if __name__ == '__main__':
    ...
    parameters = {'attack': 'GN-MI-FGSM', **vars(args), **config}
    experiment.log_parameters(parameters)


    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

    source_model = load_model_ghost(model_name=args.model, dataset=args.dataset, threat_model='Linf')
