...
#MI+SGM
python SGM-MI-FGSM.py --target resnet50 --model resnet18 --n_examples 4 --batch_size 2 --eps 0.031 --alpha 0.0078 --steps 10 --decay 1.0 --gamma 0.5

#DI+SGM
python SGM-DI-FGSM-PGD.py --target resnet50 --model resnet18 --n_examples 4 --batch_size 2 --eps 0.031 --alpha 0.0078 --steps 10 --resize_rate 0.9 --diversity_prob 0.5

#MI+DI+SGM
python SGM-DI-FGSM.py --target resnet50 --model resnet18 --n_examples 4 --batch_size 2 --eps 0.031 --alpha 0.0078 --steps 10 --decay 1.0 --resize_rate 0.9 --diversity_prob 0.5
