...
def cifar(args):
    ...
    # Create a CustomDataset object from the data and labels
    dataset = CustomDataset(x_test_correct, y_test_correct)

    # Set the batch size and create a DataLoader object from the dataset
    batch_size = 1
