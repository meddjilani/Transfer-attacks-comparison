...
from utils.modelzoo_ghost.robustbench.robustbench.model_zoo_ghost  import model_dicts as all_models_ghost
...
def load_model_ghost(model_name: str,
    ...
    models = all_models_ghost[dataset_][threat_model_]
...
def list_available_models(
    ...
    models = all_models_ghost[dataset_][threat_model_].keys()
