...
if __name__ == '__main__':
    ...
    parameters = {'attack':'DI-FGSM', 'source':args.model, 'target':args.target, 'n_examples':args.n_examples, 'eps':args.eps, 'alpha':args.alpha, 'steps':args.steps, 'decay':args.decay,
                  'resize_rate':args.resize_rate, 'diversity_prob':args.diversity_prob, 'random_start':args.random_start}
