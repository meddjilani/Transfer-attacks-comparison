...
if __name__ == '__main__':
    ...
    experiment.set_name("MI-FGSM-ENS_"+"_".join(args.model)+"_"+args.target)
    ...
    for model_name in args.model:
        ...
        if robust_model_source:
            source_model = load_model(model_name, dataset='cifar10', threat_model='Linf')
        else:
    ...
    for batch_ndx, (x_test, y_test) in enumerate(loader):
        ...
        if args.targeted:
            ...
            adv_images_MI_ENS = attack(x_test, target_labels)
        else:
        ...
        suc_rate = 1 - clean_accuracy(target_model, adv_images_MI_ENS[correct_batch_indices,:,:,:], y_test[correct_batch_indices])
