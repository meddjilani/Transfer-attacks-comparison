...
do
 ...
 do
   CUDA_VISIBLE_DEVICES=0 python VNI-FGSM.py --model $MODEL --target $TARGET --n_examples $N_EXAMPLES --eps $EPS --alpha $ALPHA --steps $STEPS --decay $DECAY --N $N --beta $BETA  --batch_size $BATCH_SIZE
 done
done
